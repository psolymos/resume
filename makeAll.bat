...
pdftk SolymosCoverletter.pdf SolymosCV.pdf SolymosResearch.pdf SolymosTeaching.pdf cat output Solymos_SFU_2015.pdf
cp Solymos_SFU_2015.pdf c:\Users\Peter\Dropbox\Public\Solymos_SFU_2015.pdf
