...
%%Please let me know when I can be scheduled to deliver a seminar to the Department of Biological Sciences as part of this application.
\vspace{0.1pc}
...
%\formatenclosure{Research statement}\\%
%\formatenclosure{Teaching interests}\\%
